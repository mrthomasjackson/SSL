...
<office:document-content
    ...
    <office:font-face-decls>
        <style:font-face style:name="Mangal1"
        ...
        <style:font-face style:name="Mangal"
            svg:font-family="Mangal" style:font-family-generic="system"
            style:font-pitch="variable" />
    ...
    <office:automatic-styles>
        ...
        <style:style style:name="P4" style:family="paragraph"
            ...
            <style:text-properties fo:font-size="12pt"
                fo:font-weight="normal" style:font-size-asian="12pt"
        ...
        <style:style style:name="P6" style:family="paragraph"
            style:parent-style-name="Horizontal_20_Line">
            <style:text-properties fo:font-size="12pt"
                fo:font-weight="normal" style:font-size-asian="12pt"
                style:font-weight-asian="normal"
                style:font-size-complex="12pt"
        ...
        <style:style style:name="fr1" style:family="graphic"
            ...
            <style:graphic-properties
                fo:margin-left="0cm" fo:margin-right="0.3cm"
                style:run-through="foreground" style:wrap="right"
    ...
    <office:body>
        <office:text>
            ...
            <text:h text:style-name="P5" text:outline-level="1">Flower
                Arrangements</text:h>
                <xsl:for-each select="root/row">
            <text:h text:style-name="Heading_20_2"
                text:outline-level="2"><xsl:value-of select="title"/></text:h>
            <text:p text:style-name="P3">
                <draw:frame draw:style-name="fr1" draw:name="graphics1"
                    text:anchor-type="paragraph" svg:x="0.06cm" svg:y="0cm"
                    svg:width="3.611cm" svg:height="3.611cm"
                    draw:z-index="0">
                    <draw:image
                        xlink:href="Pictures/10000000000000C8000000C8C6E17DCD.jpg"
